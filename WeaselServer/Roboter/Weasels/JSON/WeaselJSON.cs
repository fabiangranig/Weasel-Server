...
namespace WeaselServer.Roboter.Weasels.JSON
{
    internal class WeaselJSON
    {
        ...
        public WeaselJSON(string Name1, bool Online1, int ID1, bool HasBox1, int BatteryProcentage1, int LastPosition1, int HomePosition1, Color Color1, List<DestinationInformation> Destinations1)
        {
            this._Name = Name1;
